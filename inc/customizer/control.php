 ...
 */
class Business_Pro_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'business-pro' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'business-pro-customize-controls' );
		wp_enqueue_script( 'business-pro-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Business_Pro_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
